...
--sjdbOverhang 74 --readFilesIn /path/to/paired/file/paired_1_.fastq \
/path/to/paired/file/paired_2_.fastq --outSAMtype BAM SortedByCoordinate --quantMode GeneCounts
