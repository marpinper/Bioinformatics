...
time STAR --runThreadN 48 --runMode alignReads --genomeDir /path/to/index/ \
--sjdbGTFfile /path/to/.gtf \
--sjdbOverhang 74 \
--readFilesIn /path/to/fastq/paired/file/lane1/paired_1_.fastq,/path/to/fastq/paired/file/lane2/paired_1_.fastq \
/path/to/fastq/paired/file/lane1/paired_2_.fastq,/path/to/fastq/paired/file/lane2/paired_2_.fastq \
